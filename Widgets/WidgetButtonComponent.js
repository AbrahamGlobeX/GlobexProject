class WidgetButton extends BaseWidget {
  ...
  // 		>
  // 			< div
  // 				id={"textButton_" + this.id}
  // 				className = "WidgetButtonText"
  // 				>
  // 					 {this.text}
  // 			</div>
  // 			< div
  // 				id={"iconButton_" + this.id}
  ...
  // 	this.htmlText = document.getElementById("textButton_" + this.id);
  // 	this.htmlIcon = document.getElementById("iconButton_" + this.id);
  // 	try {
  ...
  controlFontSize() {
    if (!this.autoSize) {
      if (typeof this.htmlText != "undefined")
  ...
  controlText(stateText) {
    this.text = stateText;
    this.htmlText.innerText = stateText;
  ...
  controlHorizontalTextAlign(stateTextAlign) {
    ...
    switch (
      ...
      case 2: // TEXT CENTER
        ...
        if (
          !this.htmlElement.contains(this.htmlText) &&
  ...
  set autoFontSize(value) {
    ...
    if (!value) this.htmlElement.style.fontSize = this.fontSize + "px";
  ...
  set fontSizes(value) {
    console.log("fonstSizes", value);
    this.fontSize = value;
    this.htmlText.style.fontSize = value + "px !important";
  }
}
