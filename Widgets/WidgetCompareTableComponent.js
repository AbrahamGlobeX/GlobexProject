...
class CompareTable extends BaseObjectEditor {
  ...
  onCreate() {
    ...
    ReactComponent[dialogWindow].htmlElement.style.marginTop = "10px";
    ...
    const widgetTitle = this.drawLabel(
      headerLayout,
      `Сравнение характеристик ${this._comparedObjects.length} товаров`,
      {
        minWidth: "100%",
        maxHeight: "30%",
      }
    ...
    let buttonText = "Только различающиеся свойства";
    ...
    const widgetTitleButtonDifferent = this.drawButton(
      ...
      () => {
        ...
        buttonFlag
          ? (buttonText = "Только различающиеся свойства")
          : (buttonText = "Все свойства");
        ReactComponent[widgetTitleButtonDifferent].text = buttonText;
    ...
    ReactComponent[footerLayout].htmlElement.style.marginBottom = "30px";
    //#endregion
  }
    ...
    for (let i = 0; i < dataInfo.length + 1; i++) {
      ...
      for (let j = 0; j < infoKeys.length + 1; j++) {
        ...
        if (j == 0) {
          ...
          ReactComponent[lbl].htmlElement.style.position = "sticky";
          ReactComponent[lbl].htmlElement.style.background = "white";
          ...
          const buttonShare = this.drawLabel(tableHeaderLayout, " ", {});
          const buttonDelete = this.drawLabel(tableHeaderLayout, " ", {});
          const buttonCheck = this.drawCheckbox(
            tableHeaderLayout,
            {},
            () => {}
          );

          // TODO: добавить отображение выделенного checkbox при обновлении
          ...
          ReactComponent[buttonDelete].htmlElement.addEventListener(
            ...
            () => {
              if (confirm("Удалить объект?")) {
                ...
                ReactComponent[
                  this._widgetTitle
                ].text = `Сравнение характеристик ${this._comparedObjects.length} товаров`;
              }
            }
          );
          ...
          ReactComponent[buttonShare].htmlElement.style = "height: 20px";
          ReactComponent[buttonDelete].htmlElement.style = "height: 20px";
          ReactComponent[buttonCheck].htmlElement.style = "height: 23px";

          ReactComponent[tableHeaderLayout].htmlElement.style =
            "border-bottom: 1px solid black; height: 50px";

          ReactComponent[buttonDelete].htmlElement.style.background =
            "url('./../../assets/images/trash.png') no-repeat 50%";
          ReactComponent[buttonDelete].htmlElement.style.backgroundSize =
            "contain";

          ReactComponent[buttonShare].htmlElement.style.background =
            "url('./../../assets/images/share.png') no-repeat 50%";
          ReactComponent[buttonShare].htmlElement.style.backgroundSize =
            "contain";
          continue;
        }
    ...
    for (let j = 0; j < infoKeys.length + 1; j++) {
      ...
      if (j == 0) {
        ...
        ReactComponent[tabelHeader].htmlElement.style =
          "border-bottom: 1px solid black; height: 50px; background: white";
        ReactComponent[lbl].htmlElement.style.position = "sticky";
        continue;
      }
      this.drawLabel(lbl, "");

      const checkbx = this.drawCheckbox(
        lbl,
        {
          maxWidth: "50px",
        },
   ...
   * @memberof WidgetCompareTableComponent
   */
  getAllProperties() {
